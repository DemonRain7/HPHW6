...
export default async function ExampleCaptionsPage() {
  ...
  const columns = rows.length > 0 ? Object.keys(rows[0]) : ['id', 'image_description', 'caption', 'explanation', 'priority']
  ...
  if (error) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Example Captions</h1>
          <p className="mt-1 text-sm text-gray-500">Manage example captions.</p>
        </div>
  ...
  return (
    <CrudPage
      ...
      description="Create, view, update, and delete example captions."
